...
function SearchDatabase()
{
   ...
   this[database_length++] = new SearchPage("https://dristikononline.in/articles.html", "Dristikon Online Articles", "gita article in english, gita article in english book, gita article in english with meaning, gita article in english pdf free download, gita article in english version, drist, dristikon online website app, free, gita, vagbat gita,english articles grammar, article, articles, english article for beginners, web free, premium ,   ", "We would be happy to help you in your projects and assignments with our own articles and research works from various  fields. You can also help others with yours through us");
   this[database_length++] = new SearchPage("https://dristikononline.in/1.html", "Kaustav Roy Dristikon", "Dristikon, Drishtikon, Dristikon Online, Online, App, Android App, Short Films, Download, articles,kaustav roy dristikon online, kaustav roy rp group, kaustav roy linkedin, kaustav roy wikipedia, kaustav roy cense, kaustav roy facebook,DRIST, DEVELOPER, EDITOR,vfx, designer, main, phone ", "A Bachelor of Arts student. Chief Editor at Dristikon Online. Expertised in -Non linear editing, Pre & Post wedding photo and video editing,VFX & SFX, Folly making, Application designing & Development, Web Development,Event Managementl");
   ...
   this[database_length++] = new SearchPage("https://dristikononline.in/success_page.html", "Untitled Page", " ", "");
   this[database_length++] = new SearchPage("https://dristikononline.in/fail.html", "Untitled Page", " ", "");
   this[database_length++] = new SearchPage("https://dristikononline.in/membership.html", "Dristikon Annual Memberships", " ", "");
   ...
   this[database_length++] = new SearchPage("https://dristikononline.in/webmag.html", "Dristikon WebMag", "webmag, magazines, free, submission, upload, new web, puja, ", "'দৃষ্টিকোণ শারদসংখ্যা'-য় লেখা পাঠানোর ফর্ম..");
   ...
   this[database_length++] = new SearchPage("https://dristikononline.in/rod.html", "হুগলী জেলার পুজা পরিক্রমা With দৃষ্টিকোণ", " ", "");
